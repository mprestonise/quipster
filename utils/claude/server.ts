      ...
      messages: [
            {
                ...
                "content": [
                    ...
                    {
                      "type": "text",
                      "text": `Write an engaging, ${[prompt]} caption for this photo of a product so that it can be published to Instagram and engage buyers. Avoid cliches, avoid adding anything other than the caption, avoid using quotation marks, avoid commentary, avoid any additional updates or notes`
                  }
                ],
            }
          ]
